    ...
    {/* Section Heading */}
        ...
        <div className="grid w-[80%] mx-auto lg:grid-cols-2 gap-12 items-center ">
            ...
            <div data-aos="fade-right" data-aos-delay="0" data-aos-anchor-placement="top-center" className="relative">
                <div className="aspect-square rounded-2xl overflow-hidden p-2 ">
                    <Image src={"/images/user.jpg"} alt="profile-img" width={700} height={700} className="size-full object-cover rounded-xl" />
                </div>
            </div>
            {/* Content */}
            <div data-aos="fade-left" data-aos-delay="150" data-aos-anchor-placement="top-center"  className="space-y-6">
                <h3 className="text-2xl font-semibold">A passionate developer who loves to create</h3>
                <p className="text-muted-foreground leading-relaxed">I'm a full-stack developer with over 5 years of experience building web applications. My journey started with curiosity about how websites work, and it has evolved into a passion for creating seamless, user-focused digital experiences.</p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
                    {
                        highlights.map((item,index)=>(
                            <div className="flex items-center gap-3 text-sm" key={item.text}>
        ...
        <div className="mt-16 w-[80%] mx-auto">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                {stats.map((stat)=>(
                    <div data-aos="zoom-in" data-aos-anchor-placement="top-center" className="bg-white dark:bg-gray-800 shadow rounded-xl p-6 text-center" key={stat.label}>
